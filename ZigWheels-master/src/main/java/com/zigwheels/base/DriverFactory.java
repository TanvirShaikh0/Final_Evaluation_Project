...
public class DriverFactory 
{
	...
	public static WebDriver getDriver(String operating_System,String browserName) throws MalformedURLException {
        ...
        if(execution_env.equals("remote"))
        {
        	...
        	//DesiredCapabilities is a class in Selenium that lets you define the desired properties of the browser or 
        	//device you want to run your tests on. Think of it as a configuration sheet — you tell Selenium what kind of 
        	//browser, version, platform, or behavior you want, and it sets up the environment accordingly.
